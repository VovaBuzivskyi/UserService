...
public class UserValidatorTest {
    ...
    @Test
    public void validateUserExistenceTest2() {
        long userId = 1L;
    ...
    @Test
    public void validateUserExistenceThrowExceptionTest2() {
        long userId = 1L;

        when(userRepository.existsById(userId)).thenThrow(EntityNotFoundException.class);
